...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch(`https://igebeya3-272f297966dc.herokuapp.com/get_item_details?id=${itemId}`)
        ...
        .then(itemDetails => {
            ...
            document.getElementById("posted-by").innerHTML = `<i class="fas fa-user"></i> ${itemDetails.username}`;
            document.getElementById("joined-date").innerHTML = `<i class="fas fa-clock"></i> ${itemDetails.joined_date}`;
